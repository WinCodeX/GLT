module Api
  module V1
    class BusinessesController < ApplicationController
      ...
      # FIXED: Enhanced activities method with robust error handling and personalized descriptions
      def activities
        begin
          ...
          # UPDATED: Serialize activities with current_user context for personalized descriptions
          serialized_activities = safe_serialize_activities(activities, current_user)
      ...
      def staff_activities
        begin
          ...
          begin
            ...
            # UPDATED: Serialize activities with current_user context
            serialized_activities = safe_serialize_activities(activities, current_user)
      ...
      # UPDATED: Safe activity serialization with current_user context for personalized descriptions
      def safe_serialize_activities(activities, current_user = nil)
        return [] if activities.blank?
        
        activities.map do |activity|
          begin
            # UPDATED: Use summary_json with current_user for personalized descriptions
            activity.summary_json(current_user: current_user)
          rescue => e
